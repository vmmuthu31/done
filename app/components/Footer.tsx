    ...
    <footer className="bg-slate-900 text-white py-20">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                <MessageSquare className="text-slate-900 w-5 h-5" />
              </div>
            ...
            <p className="text-slate-400 max-w-sm mb-8">
              The iMessage-native AI agent that turns procrastination into
              execution. Built for real-world utility.
            </p>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:row justify-between items-center gap-4 text-slate-500 text-sm">
          <p>© 2026 Done. AI. All rights reserved.</p>
          <p>Built with Photon iMessage SDK</p>
        </div>
      </div>
    </footer>
  );
